...
public class irregularBird extends JFrame{
	...
	public irregularBird(){
		setTitle("Irregulars Bird \u00A9 Written by Selman \u0005 All Rigths Reserved");//set a title to frame-pencere ismi
	...
	public void addHomePage(){ 
		...
		public void mousePressed(MouseEvent arg0) {
				...
				exitFromMakers.setVisible(true);
				playerName.setVisible(false);
				timer2.start();
	...
	public void addMakersLabel(){
		...
		exitFromMakers = new JLabel(new ImageIcon(getClass().getResource("/resources/closeMakers.png")));
		exitFromMakers.setBounds(930, 25, 64, 64);
		exitFromMakers.setVisible(false);
		contentPane.add(exitFromMakers);
		...
		exitFromMakers.addMouseListener(new MouseListener() {
